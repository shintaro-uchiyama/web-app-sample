  ...
  return (
    <div className="overflow-auto h-screen pb-24 px-4 md:px-6">
      <h1 className="text-4xl font-semibold text-gray-800">
        Good afternoom, Christopher
      </h1>
      <h2 className="text-md text-gray-400">Here&#x27;s result of analysis.</h2>
      <div className="flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row">
        ...
        <div className="flex items-center w-full md:w-1/2 space-x-4">
          ...
          <div className="w-1/2">
            <div className="shadow-lg px-4 py-6 w-full bg-white relative">
              <p className="text-2xl text-black font-bold">$93.76</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
        <div className="w-full">
          <div className="shadow-lg px-4 py-6 w-full bg-white relative">
            ...
            <div className="flex items-end space-x-2 my-6">
              <p className="text-5xl text-black font-bold">12</p>
        ...
        <div className="w-full">
          <div className="shadow-lg px-4 py-6 w-full bg-white relative">
            ...
            <div className="flex items-end space-x-2 my-6">
              <p className="text-5xl text-black font-bold">23</p>
              <span className="text-green-500 text-xl font-bold flex items-center">
                <svg
                  width="20"
                  fill="currentColor"
        ...
        <div className="w-full">
          <div className="shadow-lg px-4 py-6 w-full bg-white relative">
            ...
            <div className="flex items-end space-x-2 my-6">
              <p className="text-5xl text-black font-bold">16</p>
              <span className="text-red-500 text-xl font-bold flex items-center">
                <svg
                  width="20"
                  fill="currentColor"
        ...
        <div className="w-full">
          <div className="shadow-lg px-4 py-6 w-full bg-white relative">
            ...
            <div className="flex items-end space-x-2 my-6">
              <p className="text-5xl text-black font-bold">9</p>
              <span className="text-green-500 text-xl font-bold flex items-center">
                <svg
                  width="20"
                  fill="currentColor"
        ...
        <div className="w-full">
          <div className="shadow-lg px-4 py-6 w-full bg-white relative">
            ...
            <div className="flex items-end space-x-2 my-6">
              <p className="text-5xl text-black font-bold">15</p>
              <span className="text-green-500 text-xl font-bold flex items-center">
                <svg
                  width="20"
                  fill="currentColor"
